                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-10 row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="" name="fren_titulo" wire:model="fren_titulo" oninput="this.value = this.value.replace(/[^0-9.,; ]/g, '').replace(/(\.*?)\*/g, '$1');"  maxlength="200" tabindex="75">
                                    @error('fren_titulo')
                                        <span class="error-message" style="color:red">{{ $message }}</span>
                                    @enderror
                                </div><!-- Col -->
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="" name="dere_titulo" wire:model="dere_titulo" oninput="this.value = this.value.replace(/[^0-9.,; ]/g, '').replace(/(\.*?)\*/g, '$1');"  maxlength="200" tabindex="77">
                                    @error('dere_titulo')
                                        <span class="error-message" style="color:red">{{ $message }}</span>
                                    @enderror
                                </div><!-- Col -->
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="" name="izqu_titulo" wire:model="izqu_titulo" oninput="this.value = this.value.replace(/[^0-9.,; ]/g, '').replace(/(\.*?)\*/g, '$1');"  maxlength="200" tabindex="79">
                                    @error('izqu_titulo')
                                        <span class="error-message" style="color:red">{{ $message }}</span>
                                    @enderror
                                </div><!-- Col -->
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="" name="fond_titulo" wire:model="fond_titulo" oninput="this.value = this.value.replace(/[^0-9.,; ]/g, '').replace(/(\.*?)\*/g, '$1');"  maxlength="200" tabindex="81">
                                    @error('fond_titulo')
                                        <span class="error-message" style="color:red">{{ $message }}</span>
                                    @enderror
                                </div><!-- Col -->
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="" name="fren_colinda_titulo" wire:model="fren_colinda_titulo" maxlength="200" tabindex="74">
                                    @error('fren_colinda_titulo')
                                        <span class="error-message" style="color:red">{{ $message }}</span>
                                    @enderror
                                </div><!-- Col -->
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="" name="dere_colinda_titulo" wire:model="dere_colinda_titulo" maxlength="200" tabindex="76">
                                    @error('dere_colinda_titulo')
                                        <span class="error-message" style="color:red">{{ $message }}</span>
                                    @enderror
                                </div><!-- Col -->
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="" name="izqu_colinda_titulo" wire:model="izqu_colinda_titulo" maxlength="200" tabindex="78">
                                    @error('izqu_colinda_titulo')
                                        <span class="error-message" style="color:red">{{ $message }}</span>
                                    @enderror
                                </div><!-- Col -->
                                <div class="mb-3">
                                    <input type="text" class="form-control" placeholder="" name="fond_colinda_titulo" wire:model="fond_colinda_titulo" maxlength="200" tabindex="80">
