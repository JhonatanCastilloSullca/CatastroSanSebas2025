                ...
                <div class="row">
                    <div class="row form-group">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" placeholder="" name="nume_ficha_lote" wire:model.defer="nume_ficha_lote" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="3" tabindex="2">
                                ...
                                <div class="row row3 mb-3" style="place-content: center;text-align: center;">
                                    ...
                                    <div class="col-md-1">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" readonly placeholder="" name="dc" wire:defer="dc" tabindex="15">
                                            @error('dc')
                                                <span class="error-message" style="color:red">{{ $message }}</span>
                                            @enderror
                                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-2">
                            <div class="mb-3">
                                <div wire:ignore>
                                    ...
                                    <select class="form-select insumo_id" id="hab_urbana_id" name="hab_urbana_id" data-width="100%" wire:model.defer="tipoHabi" tabindex="26">
                                        <option value="">Seleccione</option>
                        ...
                        <div class="col-md-2">
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control" name="zona_dist" wire:model.defer="zona_dist" placeholder="Zona, Sector, Etapa" onkeydown="return /[a-z]/i.test(event.key)" tabindex="28"> 
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"  name="sub_lote_dist" wire:model.defer="sub_lote_dist" placeholder="Sublote"  maxlength="4" tabindex="31">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <div wire:ignore>
                                    ...
                                    <select class="form-select"  data-width="100%" data-live-search="true" name="ubicacionpersona" id="ubicacionpersona" wire:model.defer="ubicacionpersona" tabindex="47">
                    ...
                    <div class="row form-group" wire:ignore id="ubicacion">
                        ...
                        <div class="col-md-2">
                            <div class="mb-">
                                ...
                                <input type="text" class="form-control" placeholder="" name="tipoviaotros" wire:model.defer="tipoviaotros" tabindex="52">
                                @error('tipoviaotros')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="nombreviaotros" wire:model.defer="nombreviaotros" tabindex="53">
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="ninteriorotros" maxlength="4" wire:model.defer="ninteriorotros" tabindex="55">
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="codigohurbanootros" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..?)\../g, '$1');" wire:model.defer="codigohurbanootros" tabindex="56">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label class="form-label d-inline-flex" > <div class="divcuadro">15</div> NOMBRE DE LA HABILITACION URBANA</label>
                                <input type="text" class="form-control" placeholder="" name="nombrehhurbanaotros" wire:model.defer="nombrehhurbanaotros" tabindex="57">
                        ...
                        <div class="col-md-2">
                            <div class="mb-2">
                                <label class="form-label d-inline-flex" > <div class="divcuadro">16</div> ZONA/SECTOR/ETAPA</label>
                                <input type="text" class="form-control" placeholder="" name="zonaootros" maxlength="20" wire:model.defer="zonaootros" tabindex="58">
                                @error('zonaootros')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                <label class="form-label d-inline-flex" > <div class="divcuadro">17</div> MANZANA</label>
                                <input type="text" class="form-control" placeholder="" name="manzanaotros" maxlength="3" wire:model.defer="manzanaotros" tabindex="59">
                                @error('manzanaotros')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                <label class="form-label d-inline-flex" > <div class="divcuadro">19</div> SUB-LOTE</label>
                                <input type="text" class="form-control" placeholder="" name="subloteotros" wire:model.defer="subloteotros" maxlength="6" tabindex="61">
                                @error('subloteotros')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" name="area_declarada" wire:model.defer="area_declarada" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="10" tabindex="72">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control" placeholder="" name="fond_campo" wire:model.defer="fond_campo" oninput="this.value = this.value.replace(/[^0-9.; ]/g, '').replace(/(\.*?)\*/g, '$1');" maxlength="500" tabindex="80">
                                @error('fond_campo')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div><!-- Col -->                                        
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control" placeholder="" name="fren_colinda_campo" wire:model.defer="fren_colinda_campo" maxlength="500" tabindex="75">
                                @error('fren_colinda_campo')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div><!-- Col -->                                        
                            <div class="mb-3">
                                <input type="text" class="form-control" placeholder="" name="dere_colinda_campo" wire:model.defer="dere_colinda_campo" maxlength="500" tabindex="77">
                                @error('dere_colinda_campo')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div><!-- Col -->                                        
                            <div class="mb-3">
                                <input type="text" class="form-control" placeholder="" name="izqu_colinda_campo" wire:model.defer="izqu_colinda_campo" maxlength="500" tabindex="79">
                                @error('izqu_colinda_campo')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div><!-- Col -->                                        
                            <div class="mb-3">
                                <input type="text" class="form-control" placeholder="" name="fond_colinda_campo" wire:model.defer="fond_colinda_campo" maxlength="500" tabindex="81">
                            ...
                            <div class="table-responsive">
                                <table id="vias" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            <td>
                                                <input type="text" class="form-control"  name="nume_piso[]" placeholder="N° piso" id="num_piso.{{$i}}"  wire:model.defer="num_piso.{{$i}}"  maxlength="2" tabindex="89">
                                                @error('num_piso.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </td>
                                            ...
                                            <td>
                                                <select class="form-select"  data-width="100%" data-live-search="true" name="mep.{{$i}}" id="mep.{{$i}}" wire:model.defer="mep.{{$i}}" tabindex="91">
                                                    <option value="" >SELECCIONE</option>
                                            ...
                                            <td>
                                                <select class="form-select"  data-width="100%" data-live-search="true" name="ecs.{{$i}}" id="ecs.{{$i}}" wire:model.defer="ecs.{{$i}}" tabindex="92">
                                                    <option value="" >SELECCIONE</option>
                                            ...
                                            <td>    
                                                <select class="form-select"  data-width="100%" data-live-search="true" name="ecc.{{$i}}" id="ecc.{{$i}}" wire:model.defer="ecc.{{$i}}" tabindex="93">
                                                    <option value="" >SELECCIONE</option>
                                            ...
                                            <td>
                                                <input type="text" class="form-control"  name="estr_muro_col[]" placeholder="MUROS" wire:model.defer="estr_muro_col.{{$i}}"  onkeydown="return /[a-z]/i.test(event.key)" maxlength="1" tabindex="94">
                                                @error('estr_muro_col.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror        
                                            </td> 
                                            <td>
                                                <input type="text" class="form-control"  name="estr_techo[]" placeholder="TECHOS" wire:model.defer="estr_techo.{{$i}}"   onkeydown="return /[a-z]/i.test(event.key)" maxlength="1" tabindex="95">
                                                @error('estr_techo.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </td>
                                            <td>
                                                <input type="text" class="form-control"  name="acab_piso[]" placeholder="PISOS" wire:model.defer="acab_piso.{{$i}}"  onkeydown="return /[a-z]/i.test(event.key)" maxlength="1" tabindex="96">
                                                @error('acab_piso.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </td>
                                            <td>                                    
                                                <input type="text" class="form-control"  name="acab_puerta_ven[]" placeholder="P. Y V." wire:model.defer="acab_puerta_ven.{{$i}}"  onkeydown="return /[a-z]/i.test(event.key)" maxlength="1" tabindex="97">
                                                @error('acab_puerta_ven.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </td>
                                            <td>
                                                <input type="text" class="form-control"  name="acab_revest[]" placeholder="REVEST." wire:model.defer="acab_revest.{{$i}}"   onkeydown="return /[a-z]/i.test(event.key)" maxlength="1" tabindex="98">
                                                @error('acab_revest.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </td>
                                            <td>
                                                <input type="text" class="form-control"  name="acab_bano[]" placeholder="BAÑOS" wire:model.defer="acab_bano.{{$i}}"  onkeydown="return /[a-z]/i.test(event.key)" maxlength="1" tabindex="99">
                                                @error('acab_bano.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </td>
                                            <td>                                    
                                                <input type="text" class="form-control"  name="inst_elect_sanita[]" placeholder="INST. E." wire:model.defer="inst_elect_sanita.{{$i}}"  onkeydown="return /[a-z]/i.test(event.key)" maxlength="1" tabindex="100">
                                                @error('inst_elect_sanita.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </td>
                                            <td>                                    
                                                <input type="text" class="form-control"  name="area_verificada[]" placeholder="AREA VERIFICADA" wire:model.defer="area_verificada.{{$i}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="7"  tabindex="101">
                                                @error('area_verificada.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </td>
                                            <td>
                                                <select class="form-select"  data-width="100%" data-live-search="true" name="uca.{{$i}}" id="uca.{{$i}}" wire:model.defer="uca.{{$i}}" tabindex="102">
                                                    <option value="" >SELECCIONE</option>
                    ...
                    <div class="row form-group">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="porc_bc_terr_legal" wire:model.defer="porc_bc_terr_legal" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="5" tabindex="104">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"  name="porc_bc_const_legal" wire:model.defer="porc_bc_const_legal" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="5" tabindex="105">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="porc_bc_terr_fisc"  wire:model.defer="porc_bc_terr_fisc" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="5" tabindex="106">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="porc_bc_const_fisc" wire:model.defer="porc_bc_const_fisc" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="5" tabindex="107">
                                ...
                                <table id="vias" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            ...
                                            <td>
                                                    <input type="month" class="form-control" name="inst_fecha[]" placeholder="FECHA" id="inst-fecha.{{$i}}" wire:model.defer="inst_fecha.{{$i}}" tabindex="110">
                                                    @error('inst_fecha.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                    @enderror
                                                </td>
                                            <td>
                                                <select class="form-select"  data-width="100%" data-live-search="true" name="inst_mep.{{$i}}" id="inst_mep.{{$i}}" wire:model.defer="inst_mep.{{$i}}" tabindex="111">
                                                    <option value="" >SELECCIONE</option>
                                                    @foreach(\App\Models\TablaCodigo::where('id_tabla','=','MEP')->orderby('codigo','asc')->get() as $tablacodigo)
                                                        <option value="{{$tablacodigo->codigo}}">{{$tablacodigo->codigo}} {{$tablacodigo->desc_codigo}}</option>
                                                    @endforeach
                                            ...
                                            <td>        
                                                <select class="form-select"  data-width="100%" data-live-search="true" name="inst_ecs.{{$i}}" id="inst_ecs.{{$i}}" wire:model.defer="inst_ecs.{{$i}}" tabindex="112">
                                                    <option value="" >SELECCIONE</option>
                                                    @foreach(\App\Models\TablaCodigo::where('id_tabla','=','ECS')->orderby('codigo','asc')->get() as $tablacodigo)
                                                        <option value="{{$tablacodigo->codigo}}">{{$tablacodigo->codigo}} {{$tablacodigo->desc_codigo}}</option>
                                                    @endforeach
                                            ...
                                            <td>
                                                <select class="form-select"  data-width="100%" data-live-search="true" name="inst_ecc.{{$i}}" id="inst_ecc.{{$i}}" wire:model.defer="inst_ecc.{{$i}}" tabindex="113">
                                                    <option value="" >SELECCIONE</option>
                                                    @foreach(\App\Models\TablaCodigo::where('id_tabla','=','ECC')->orderby('codigo','asc')->get() as $tablacodigo)
                                                        <option value="{{$tablacodigo->codigo}}">{{$tablacodigo->codigo}} {{$tablacodigo->desc_codigo}}</option>
                                                    @endforeach
                                            ...
                                            <td>
                                                <input type="text" class="form-control"  name="inst_prod_total[]" placeholder="PRODUCTO TOTAL" id="inst-prod_total.{{$i}}"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="7" wire:model.defer="inst_prod_total.{{$i}}" tabindex="114">
                                                @error('inst_prod_total.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </td>
                                            <td>
                                                <input type="text" class="form-control"  name="inst_uni_med[]" placeholder="U. MEDIDA" id="inst-uni_med.{{$i}}" maxlength="10"  wire:model.defer="inst_uni_med.{{$i}}" tabindex="115">
                                                @error('inst_uni_med.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </td>
                                            <td>
                                                <select class="form-select"  data-width="100%" data-live-search="true" name="inst_uca.{{$i}}" id="inst_uca.{{$i}}" wire:model.defer="inst_uca.{{$i}}" tabindex="116">
                                                    <option value="" >SELECCIONE</option>
                                                    @foreach(\App\Models\TablaCodigo::where('id_tabla','=','UCA')->orderby('codigo','asc')->get() as $tablacodigo)
                                                        <option value="{{$tablacodigo->codigo}}">{{$tablacodigo->codigo}} {{$tablacodigo->desc_codigo}}</option>
                                                    @endforeach
                                ...
                                <table id="vias" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            ...
                                            <td>
                                                <input type="text" class="form-control"  name="nume_documento[]" placeholder="N° DE DOCUMENTO" id="Documento.{{$i}}"  maxlength="20" wire:model.defer="nume_documento.{{$i}}" tabindex="120">
                                                @error('nume_documento.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </td>
                                            <td>
                                                <input type="date" class="form-control"  name="fecha_dococumento[]" placeholder="FECHA" id="fecha_dococumento.{{$i}}"  wire:model.defer="fecha_dococumento.{{$i}}" tabindex="121">
                                                @error('fecha_dococumento.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </td>
                                            <td>
                                                <input type="text" class="form-control"  name="area_autorizadadocumento[]" placeholder="AREA AUTORIZADA" id="area_autorizadadocumento.{{$i}}"  wire:model.defer="area_autorizadadocumento.{{$i}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="7" tabindex="122">
                    ...
                    <label class="form-label d-inline-flex" > <div class="divcuadro">87</div>ÁREA DE TERRENO INVADIDA (M2)</label>
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" id="en_colindante" class="form-control" placeholder="EN LOTE COLINDANTE" name="en_colindante" wire:model.defer="en_colindante" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="7" tabindex="132">
                                @error('en_colindante')
                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" id="en_area_publica" class="form-control" placeholder="EN AREA PUBLICA" name="en_area_publica" wire:model.defer="en_area_publica" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="7" tabindex="133">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" id="en_jardin_aislamiento" class="form-control" placeholder="EN JARDIN  DE AISLAMIENTO" name="en_jardin_aislamiento" wire:model.defer="en_jardin_aislamiento" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="7" tabindex="134">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" id="en_area_intangible" class="form-control" placeholder="EN AREA INTANGIBLE" name="en_area_intangible" wire:model.defer="en_area_intangible" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength="7" tabindex="135">
                                ...
                                <table id="vias" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            ...
                                            <td>
                                                <input type="text" class="form-control"  name="codi_contribuye[]" placeholder="CODIGO DE CONTRIBUYENTE" id="codi_contribuye{{$i}}" wire:model.defer="codi_contribuye.{{$i}}"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"  maxlength="18" tabindex="144">
                                                @error('codi_contribuye.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </td> 
                                            <td>
                                                <input type="text" class="form-control"  name="nombreslitigante[]" placeholder="NOMBRES" id="nombres{{$i}}" wire:model.defer="nombres.{{$i}}"  onkeydown="return /[a-ñ. ;]/i.test(event.key)" tabindex="145">
                                                @error('nombres.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </td>
                                            <td>
                                                <input type="text" class="form-control"  name="ape_paternolitigante[]" placeholder="APELLIDO PATERNO" id="ape_paterno{{$i}}" wire:model.defer="ape_paterno.{{$i}}" onkeydown="return /[a-ñ. ;]/i.test(event.key)" tabindex="146">
                                                @error('ape_materno.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </td>
                                            <td>
                                                <input type="text" class="form-control"  name="ape_maternolitigante[]" placeholder="APELLIDO MATERNO" id="ape_materno{{$i}}" wire:model.defer="ape_materno.{{$i}}"  onkeydown="return /[a-ñ. ;]/i.test(event.key)" tabindex="147">
                                                @error('ape_paterno.'.$i)
                                                    <span class="error-message" style="color:red">{{ $message }}</span>
                                                @enderror
                                            </td>              
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="nume_registro" wire:model.defer="nume_registro" tabindex="160">
                            @error('nume_registro')
                                <span class="error-message" style="color:red">{{ $message }}</span>
                            @enderror
                            <label class="form-label d-inline-flex" > FECHA</label>
