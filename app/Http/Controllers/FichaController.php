...
class FichaController extends Controller
{
    ...
    public function duplicarCotitular(DuplicarFichaRequest $request)
    {
        ...
        foreach($fichaAnterior->titulars as $titularAnterior)
        {
            ...
            $domicilio->codi_via=$domicilioAnterior->codi_via;
            $domicilio->tipo_via=$domicilioAnterior->tipo_via;
            $domicilio->nomb_via=$domicilioAnterior->nomb_via;
            $domicilio->nume_muni=$domicilioAnterior->nume_muni;
            $domicilio->nomb_edificacion=$domicilioAnterior->nomb_edificacion;
            $domicilio->nume_interior=$domicilioAnterior->nume_interior;
            $domicilio->codi_hab_urba=$domicilioAnterior->codi_hab_urba;
            $domicilio->nomb_hab_urba=$domicilioAnterior->nomb_hab_urba;
            $domicilio->sector=$domicilioAnterior->sector;
            $domicilio->mzna=$domicilioAnterior->mzna;
            $domicilio->lote=$domicilioAnterior->lote;
