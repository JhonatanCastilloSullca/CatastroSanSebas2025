        ...
        try
        {
            ...
            if($autorizaciones !=""){
                while($contcon < $this->cont2){
                    ...
                    $anuncios->id_anuncio=$ficha->id_ficha.''.str_pad($this->codianuncio[$contcon],3,'0',STR_PAD_LEFT).''.str_pad($contcon,3,'0',STR_PAD_LEFT);
                    $anuncios->id_ficha=$ficha->id_ficha;
                    $anuncios->codi_autoriza=str_pad($contcon,3,'0',STR_PAD_LEFT);
