...
Route::group(['middleware'=>['auth']], function () {
    ...
    Route::get('/ficha/destroybiencultural/{fichaanterior}', 'App\Http\Controllers\FichaBienCulturalController@destroybiencultural')->name('ficha.destroybiencultural');
    ...
    Route::post('duplicar-bien-cultural', 'App\Http\Controllers\FichaController@duplicarCultural')->name('ficha.duplicarCultural');
